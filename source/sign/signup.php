...
if (!empty($_POST["login_su"]) AND !empty($_POST["password_su"]) AND !empty($_POST["email_su"]) AND !empty($_POST["age"])) {
	...
	add_member($login, $password, $age, $email, $db); //On rajoute cet utilisateur
